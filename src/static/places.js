...
どこに行ってものりぴーはそのままの姿で自分がやりたいことにトライしてください！絶対上手くいくから！！
これからののりぴーの目覚ましい活躍を楽しみにしてるね！！
またふらっとジーズに遊びにきてね！改めて、おめでとう！！`,
        imageUrl: process.env.PUBLIC_URL + "/assets/maeta.JPG",
        time: 1500,
    },
    {
        title: "TDさん",
        description: `のりぴー１年半お疲れさまでした。仕事上の直接的な関係はなかったけれど、一緒に日本酒を飲みに行ったり、コインランドリーを探して渋谷をさまよったことは良い思い出です。
特にコインランドリーの時の事はよく覚えています。コインランドリーは見つからない、両替ミスって小銭はない、レストランは定休日、洗濯物は乾いてない、入ったカフェは宗教系、帰りのタクシーは通らない、と散々でしたよね。でも不思議と楽しかった。
のりぴーには人を楽しい気分にさせるセンスがあると思います。楽しい気分はどんな逆境も跳ね返す宝石のようなもの。それを人に与えられるのりぴーの明るい笑顔と陽気なノリはとても素敵です。
