const places = [
    ...
    },
    {
        ...
        そして、数ヶ月後にはG'sに戻っているはず！！笑
        　またG'sで会える日を楽しみにしています〜。
        by 東京DEV22_大木千卓`,
    ...
    {
        title: "DEV22 仁さん",
        description: `副担任お疲れ様でした！
            大堀さんに代わりクラスをまとめていてすごいなと思っておりました！
            今度こそ鳥メロ行きましょう！`,
    ...
    {
        title: "DEV22 Girls",
        description: `【峯村】ご卒業おめでとうございます。 お身体に気を付けて、新社会人として充実した毎日を送って下さいね。
            より一層のご活躍をお祈りしています。
            【會澤】のりぴーさん、インターンお疲れ様でした。 いつも可愛らしいのりぴーさんの存在は勉強の中の癒しでした！きっとG’sに配属されると思うので（笑）その時はまた宜しくお願いします！
            【守屋】のりピーさんご卒業おめてとうございます！！ 
            いつもエラーに悩まされていますが、G’sでのりピーさんの笑顔に癒されています！ 
